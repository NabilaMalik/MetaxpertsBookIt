...
class DBHelper{
 /// In Dart, the underscore (_) at the beginning of a variable or method name indicates private access.
  ...
  _onCreate(Database db, int version){
    ...
    db.execute("CREATE TABLE $orderDetailsTableName (id INTEGER PRIMARY KEY,orderMasterId INTEGER, product TEXT, quantity TEXT, inStock INTEGER, rate REAL, amount REAL, FOREIGN KEY(orderMasterId) REFERENCES $orderMasterTableName(orderMasterId))");
